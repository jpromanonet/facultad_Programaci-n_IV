  ...
  <body>
    <form id="form1" runat="server">
        ...
        <table style="width: 100%">
          ...
          <tr>
            <td style="text-align: center">
              <asp:Label
                ID="lblMsgLogin"
                Text="Ingresa tu Usuario y Contraseña, y presiona ENTRAR"
                runat="server"
                Font-Bold="true"
                Font-Size="X-Large"
              />
        ...
        <table style="width: 100%">
          ...
          <tr>
            <td colspan="4" style="text-align: right">
              <asp:Label
                ID="lblAdmin"
                Text="Si eres Administrador usa este Botón para Ingresar "
                runat="server"
                Font-Bold="true"
                Font-Size="Large"
              />
          ...
          <tr>
            <td colspan="5" style="text-align: center">
              <asp:ImageButton
                ID="btnReenviarClave"
                ImageUrl="~/imagenes/reenviarclave.png"
                runat="server"
                Visible="true"
              />
              <asp:Label
        ...
        <table style="width: 100%">
          <tr>
            <td style="text-align: center">
              <asp:ImageButton
                ID="btnVolverLogin"
                ImageUrl="~/imagenes/terminarvolver.png"
                runat="server"
                Width="259px"
                Height="68px"
              />
        ...
        <table style="width: 100%">
          ...
          <tr>
            <td style="text-align: center">
              <asp:ImageButton
                ID="btnRegistrarse"
                ImageUrl="~/imagenes/registrateaqui.png"
                runat="server"
              />
            </td>
          </tr>
          <tr>
            <td style="text-align: center">
              <asp:ImageButton
                ID="btnIrLogin"
                ImageUrl="~/imagenes/yaregistrado.png"
                runat="server"
              />
            </td>
          </tr>
          <tr>
            <td style="text-align: center">
              <asp:ImageButton
                ID="btnRegistrarseVolverLoginU13"
                ImageUrl="~/imagenes/terminarvolver.png"
                runat="server"
                Width="259px"
                Height="68px"
      ...
      <asp:Panel
        ...
        Font-Size="Large"
        Visible="false"
        BackImageUrl="~/imagenes/fondo.jpg"
      >
        ...
        <table style="width: 100%">
          ...
          <tr>
            <td style="text-align: center">
              <asp:Image
                ImageUrl="~/imagenes/headerregistrarse.png"
                runat="server"
                Width="767px"
              />
            </td>
          ...
          <tr>
            <td style="text-align: justify">
              <p>
                Para Poder registrarte debés ser mayor de 18 años, residir en
                Argentina y contar con documento válido en Argentina que
                acredite tu identidad.
              </p>
              <p>
                Sólo se pude hacer un resgistro por documento. Los datos deben
                ser reales, correctos y vigintes.
              </p>
              <p>
        ...
        <table style="width: 100%">
          <tr style="text-align: center">
            <td>
              <asp:ImageButton
                ID="btnRegistrarseU"
                ImageUrl="~/imagenes/registrarse.png"
                runat="server"
              />
            </td>
            <td>
              <asp:ImageButton
                ID="btnCancelarVolverU"
                ImageUrl="~/imagenes/cancelarvolver.png"
                runat="server"
              />
            </td>
          </tr>
          ...
          <tr>
            <td style="text-align: justify">
              <asp:Label
                ...
                Visible="false"
              />
              <p>Ya estás Registrado al Sistema de Pedidos Online FASTSELL</p>
              <p></p>
              <p>
                Nos alegra mucho que estés con nosotros . El Equipo FASTSELL
              </p>
            </td>
          </tr>
          <tr>
        ...
        <table style="width: 100%">
          ...
          <tr>
            <td style="text-align: center">
              <asp:ImageButton
                ID="btnAhoraQueHago"
                ImageUrl="~/imagenes/ahora_que_hago.png"
                runat="server"
              />
              <p>
                Desde acá vas a poder hacer varias cosas relacionadas con tu
                cuenta en FASTSELL
              </p>
            </td>
          </tr>
          <tr>
            <td style="text-align: center">
              <asp:ImageButton
                ID="btnHacerPedido"
                ImageUrl="~/imagenes/hacerpedido.png"
                runat="server"
              />
            </td>
          </tr>
          <tr>
            <td style="text-align: center">
              <asp:ImageButton
                ID="btnVerHistorico"
                ImageUrl="~/imagenes/vertodosmov.png"
                runat="server"
              />
            </td>
          </tr>
          <tr>
            <td style="text-align: center">
              <asp:ImageButton
                ...
                ImageUrl="~/imagenes/modificardatos.png"
                runat="server"
              />
            </td>
          </tr>
          <tr>
            <td style="text-align: center">
              <asp:ImageButton
                ID="btnAbmProductos"
                ImageUrl="~/imagenes/abmProductos.png"
                runat="server"
                Width="263px"
              />
            </td>
          ...
          <tr>
            <td style="text-align: center">
              <asp:ImageButton
                ID="btnHacerPedidoFabrica"
                ImageUrl="~/imagenes/pedidosfabrica.png"
                runat="server"
                Visible="false"
              />
            </td>
          ...
          <tr>
            <td style="text-align: center">
              <asp:ImageButton
                ID="btnAbmPedidoFabrica"
                ImageUrl="~/imagenes/abmPedidosFabrica.png"
                runat="server"
                Visible="false"
              />
            </td>
      ...
      >
        <table style="width: 100%">
          ...
          <tr>
            <td style="text-align: justify">
              <p>Sistema de Pedidos Online FASTSELL</p>
              <p></p>
              <p>
                A través de este Sistema, vas a poder comprar los equipos
                informáticos más innovadores hasta el día de hoy; vas a poder
                encontrar confianza, calidad y sobre todo el mejor precio para
      ...
      <asp:Panel
        ...
        Font-Size="Large"
        Visible="false"
        BackImageUrl="~/imagenes/datospersonales.jpg"
      >
        <%--Tabla Datos para Registro--%>
        <table style="width: 100%">
          <%--Campos y Validacion Email.--%>
        ...
        <table style="width: 100%">
          <tr style="text-align: center">
            <td>
              <asp:ImageButton
                ID="btnCambiarDatos"
                ImageUrl="~/imagenes/cambiarlosdatos.png"
                runat="server"
              />
            </td>
            <td>
              <asp:ImageButton
                ID="btnCancelarVolverEdit"
                ImageUrl="~/imagenes/cancelarvolver.png"
                runat="server"
              />
            </td>
      ...
      >
        ...
        <table style="width: 100%">
          ...
          <tr style="text-align: center">
            <td>
              <asp:ImageButton
                ID="btnVolverAreaUsuario"
                ImageUrl="~/imagenes/volveratuarea.png"
                runat="server"
              />
            </td>
          </tr>
        ...
        <table style="width: 100%">
          ...
          <tr style="text-align: center">
            <td>
              <asp:ImageButton
                ID="btnNuevoPedido"
                ImageUrl="~/imagenes/nuevopedido.png"
                runat="server"
              />
            </td>
          </tr>
          <tr style="text-align: center">
            <td>
              <asp:ImageButton
                ID="btnTodosLosPedidos"
                ImageUrl="~/imagenes/todoslospedidos.png"
                runat="server"
              />
            </td>
          </tr>
          ...
          <tr style="text-align: center">
            <td>
              <asp:ImageButton
                ID="btnTerminarVolverPedido"
                ImageUrl="~/imagenes/terminar.png"
                runat="server"
              />
            </td>
          </tr>
        ...
        <table style="width: 100%">
          ...
          <tr>
            <td class="auto-style3">
              <asp:ImageButton
                ID="btnQuitarTodos"
                ImageUrl="~/imagenes/quitartodos.png"
                runat="server"
              />
            </td>
            <td colspan="2">
              <asp:ImageButton
                ID="btnSolicitarPedido"
                ImageUrl="~/imagenes/solicitar.png"
                runat="server"
              />
            </td>
            <td>
              <asp:ImageButton
                ...
                ImageUrl="~/imagenes/cancelarpedido.png"
                runat="server"
              />
            </td>
          </tr>
      ...
      >
        ...
        <table style="width: 100%">
          ...
          <tr style="text-align: center">
            <td>
              <asp:ImageButton
                ID="btnActulizarHistorico"
                ImageUrl="~/imagenes/actualizar.png"
                runat="server"
              />
            </td>
            <td>
              <asp:ImageButton
                ID="btnTerminarHistorico"
                ImageUrl="~/imagenes/terminarvolver.png"
                runat="server"
              />
            </td>
      ...
      >
        ...
        <table style="width: 100%">
          <tr style="text-align: left">
            <td>
              <h2>
                Datalle del Pedido Nº:
                <asp:Label ID="lblNroPedido" Text="" runat="server" />
              </h2>
            </td>
          </tr>
          <tr style="text-align: center">
        ...
        <table style="width: 100%">
          ...
          <tr style="text-align: center">
            <td>
              <asp:ImageButton
                ID="btnNuevoProducto"
                ImageUrl="~/imagenes/nuevoproducto.png"
                runat="server"
              />
            </td>
          </tr>
          <tr style="text-align: center">
            <td>
              <asp:ImageButton
                ID="btnTodosLosProductos"
                ImageUrl="~/imagenes/todoslosproductos.png"
                runat="server"
              />
            </td>
          </tr>
      ...
      >
        ...
        <table style="width: 100%">
          ...
          <tr>
            <td style="text-align: center">
              <h2>Bienvenido al Alta de Productos</h2>
            </td>
          </tr>
        </table>
      ...
      >
        ...
        <table style="width: 100%">
          ...
          <tr style="text-align: center">
            <td>
              <asp:Label
                ID="lblProductoCreado"
                Text="El Producto Fue dado de Alta Correctamente."
                runat="server"
                Font-Bold="true"
                Font-Size="Large"
              />
      ...
      >
        ...
        <table style="width: 100%">
            ...
            <td colspan="2">
              ...
              >
                ...
                <Columns>
                  ...
                  />
                  <asp:BoundField
                    DataField="StockProducto"
                    HeaderText="Stock"
                  />
                  <asp:ButtonField
                    ButtonType="Button"
                    CommandName="VerEditar"
                    HeaderText="Acción"
          ...
          <tr style="text-align: center">
            <td>
              <asp:ImageButton
                ID="btnActulizarListadoProducto"
                ImageUrl="~/imagenes/actualizar.png"
                runat="server"
              />
            </td>
      ...
      >
        ...
        <table style="width: 100%">
          ...
          <tr>
            <td style="text-align: center">
              <h2>
                Estas Viendo el Producto:
                <asp:Label ID="lblCodigoProducto" Text="" runat="server" />
              </h2>
            </td>
          </tr>
        </table>
        ...
        <table style="width: 100%">
          ...
          <tr style="text-align: center; vertical-align: central">
            ...
            <td style="text-align: center; vertical-align: central">
              <asp:ImageButton
                ID="btnFiltrarCliente"
                ImageUrl="~/imagenes/filtrarCliente.png"
                runat="server"
              />
            </td>
          </tr>
          ...
          <tr style="text-align: center">
            <td>
              <asp:ImageButton
                ID="btnActualizarPedidosClientes"
                ImageUrl="~/imagenes/actualizar.png"
                runat="server"
              />
            </td>
            <td>
              <asp:ImageButton
                ID="btnVolverAbmPedidosClientes"
                ImageUrl="~/imagenes/terminarvolver.png"
                runat="server"
              />
            </td>
        ...
        <table style="width: 100%">
          <tr style="text-align: left">
            <td>
              <h3>
                Datalle del Pedido Nº
                <asp:Label ID="lblNroPedidoCliente" runat="server" /> &nbsp;del
                Cliente <asp:Label ID="lblNroCliente" Text="" runat="server" />
              </h3>
            </td>
          </tr>
          <tr style="text-align: center">
          ...
          <tr style="text-align: center">
            <td style="text-align: center">
              <asp:ImageButton
                ID="btnTerminarVolverAbmFabrica"
                ImageUrl="~/imagenes/terminarvolver.png"
                runat="server"
              />
            </td>
